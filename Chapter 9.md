...
<ul>
<li>If the indifference curve is steep the marginal rate of substitution is <em>high</em>, the person will give up a large quantity of good x to get an additional unit of good y while remaining indifferent</li>
<li>Vice versa if slope is flat<br>
This shows dimnishing marginal rate of substitution as the indifference curve is bowed inwards, and starts steep but ends shallow.</li>
</ul>
<h3 id="degree-of-subtsitutability">Degree of Subtsitutability</h3>
<p>Two ordinary (normal) goods would have a bowed indifference curve.</p>
<h4 id="close-substitutes">Close substitutes</h4>
<p>The closer substitutes two items are the less bowed an indifference curve is<br>
The indifference curves for perfect substitutes are straight lines sloping downward.</p>
<h4 id="complements">Complements</h4>
<p>The closer to being perfect complements two items are the closer the marginal rate of substitution is to being a constant and the more bowed an indifference curve is.<br>
The indifference curves for perfect complements look like an L</p>
<h2 id="predicting-consumer-choices">Predicting Consumer Choices</h2>
<h3 id="best-affordable-choice">Best Affordable Choice</h3>
<p>The best affordable choice is a point in which all income is spent, and the consumer is on their highest attainable indifference curve<br>
This is shown as the point a consumers budget line crosses its highest indifference curve</p>
<h4 id="on-the-budget-line">On the Budget Line</h4>
<p>The best affordable point is on the budget line, as every point inside the budget line there are points on the line that the consumer prefers.</p>
<h4 id="on-the-highest-attainable-difference-curve">On the highest attainable difference curve</h4>
<p>Every point on the budget line occurs on an indifference curve, the highest indifference curve on the budget  (the one making the consumer the most happy) will therefore be the best affordable choice</p>
<h4 id="marginal-rate-of-substitution-equals-relative-price">Marginal Rate of Substitution equals Relative Price</h4>
<p>At the best affordable choice the MRS equals the relative price, which means the slope of the budget line is equal to the slope of the indifference curve at that point</p>
<h3 id="a-change-in-price-1">A Change in Price</h3>
<p>The <em>Price Effect</em> is the effect of a change in price of a good on the quantity of goods consumed</p>
<p><em>Recall: an increase in price of the good on the x-axis of the budget line steepens the slope of the budget line (Relative Price up) vice versa for decrease in price</em></p>
<p>When the price of good x falls and the price of good x falls and the price of good y and income stays the same, the consumer will buy more of good x and less of good y (substitute more of x for y)</p>
<h4 id="the-demand-curve">The Demand Curve</h4>
<p>In Ch 3. it was asserted that demand curves slope downward, we can now derive this using a consumers budget line and their indifference curves. By doing this we can see the law of demand and the downward slope are consequences of a consumer choosing their best affordable combination of goods.</p>
<p>To derive a demand curve Lower the price of good x and find the consumers best affordable choice at different prices. This will result in a downwards sloping curve, the lower the price of good x, the more of good x a consumer consumes, this is the law of demand.</p>
<h3 id="a-change-in-income-1">A Change in Income</h3>
<p>the <em>income effect</em> is the effect of a change in income on buying plans.</p>
<p><em>Recall: an increase in income moves the budget line to the right (increases the y-axis) and a decrease in income moves the budget line to the left (decreases the y-axis)</em></p>
<p>If when income falls the best affordable choice falls as well then the good is anormal good.</p>
<p>If when income raises the best affordable choice falls then the good is an inferior good</p>
<h4 id="the-demand-curve-and-the-income-effect">The Demand Curve and the Income Effect</h4>
<p>When income lowers the demand curve shifts left, as the best affordable point for normal goods at the same price will decrease. Vice versa for increase in income</p>
<h3 id="substitution-effect-and-income-effect">Substitution Effect and Income Effect</h3>
<p>For a normal good, a fall in price <em>always</em> increases the quantity bought. We can prove this by dividing the price effect into two parts:</p>
<ul>
